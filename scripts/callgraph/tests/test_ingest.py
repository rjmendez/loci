...
def test_load_corpus_worktree_parses_147_files_with_no_errors():
    """127 -> 128 -> 129 -> 130 -> 131 -> 132 -> 133 -> ... -> 142 -> 143 -> 144 -> 145 -> 146 -> 147:
    ...
    assert len(sources) == 147  # swarm_supervisor.py, demo_swarm_supervisor.py added
