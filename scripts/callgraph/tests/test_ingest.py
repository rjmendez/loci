...
def test_load_corpus_worktree_parses_145_files_with_no_errors():
    ...
    classification), mcp/provenance_firewall.py (finding provenance gate),
    scripts/issue_proposer.py (guarded reflection-loop
    issue proposer), then scripts/stigmergic_consensus.py (opt-in stigmergic
    consensus gate for swarm findings)."""
