...
count (148), not a vibe. If this drifts, either the repo changed shape or
...
def test_corpus_is_exactly_148_files():
    """127 -> 128 -> 129 -> 130 -> 131 -> 132 -> 133 -> ... -> 140 -> 141 -> 142 -> 143 -> 144 -> 145 -> 146 -> 147 -> 148:
    ...
    assert len(files) == 148, sorted(files)
