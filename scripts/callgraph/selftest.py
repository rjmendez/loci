...
def _check_real_corpus():
    ...
    store = result.store
    assert result.meta.file_count == 145, result.meta.file_count  # 128 -> ... -> 142 -> 143 -> 144 -> 145: compact, deploy, A/B eval, prefilter, guardian, procedure-learning, conflict-verify, pre-answer-entailment, consolidation-audit, reflection-triage, wiring-obligation, local-deep-think, redteam-harness, swarm-escalate, bench-local-models, issue-proposer, stigmergic-consensus
