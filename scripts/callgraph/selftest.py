...
def _check_real_corpus():
    ...
    store = result.store
    assert result.meta.file_count == 136, result.meta.file_count  # 128 -> ... -> 135 -> 136: compact, deploy, A/B eval, prefilter, guardian, procedure-learning, conflict-verify, pre-answer-entailment
