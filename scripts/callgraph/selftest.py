...
def _check_real_corpus():
    ...
    store = result.store
    assert result.meta.file_count == 135, result.meta.file_count  # 128 -> 129 -> 130 -> 131 -> 132 -> 133 -> 134 -> 135: compact, deploy, A/B eval, prefilter, guardian, procedure-learning, conflict-verify
