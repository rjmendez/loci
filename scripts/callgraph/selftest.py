...
def _check_real_corpus():
    ...
    store = result.store
    assert result.meta.file_count == 144, result.meta.file_count  # 128 -> ... -> 140 -> 142 -> 144: compact, deploy, A/B eval, prefilter, guardian, procedure-learning, conflict-verify, pre-answer-entailment, consolidation-audit, reflection-triage, wiring-obligation, local-deep-think, redteam-harness, swarm-escalate, swarm-supervisor
